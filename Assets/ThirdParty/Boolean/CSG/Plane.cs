...
#pragma warning restore RECS0018 // Comparison of floating point numbers with equality operator
        ...
        public unsafe void SplitPolygon(Polygon polygon, out SplitPolygonResult result)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (frontvertices.Count >= 3)
                    {
                        result.Front = new Polygon(1, frontvertices, polygon.Shared, polygon.Plane);
                    }
                    if (backvertices.Count >= 3)
                    {
                        result.Back = new Polygon(1, backvertices, polygon.Shared, polygon.Plane);
                    }
                }
            }
        }
        Vertex SplitLineBetweenVertices(Vertex v1, Vertex v2)
        {
            ...
            var uv= v1.Uv+(UVdirection * (u));
            return new Vertex(result, uv, tresult);
        }
