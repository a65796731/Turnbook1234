...
namespace Csg
{
    ...
    public class Polygon
    {
        ...
        public Polygon(int flags,List<Vertex> vertices, PolygonShared shared = null, Plane plane = null)
        {
            Flags = flags;
            Vertices = vertices;
            Shared = shared != null ? shared : defaultShared;
            Plane = plane != null ? plane : Plane.FromVector3Ds(vertices[0].Pos, vertices[1].Pos, vertices[2].Pos);
            if (debug)
            {
                //CheckIfConvex();
            }
        ...
        public Polygon(int flags, params Vertex[] vertices)
            : this(flags,new List<Vertex>(vertices))
        {
        }
        ...
        public Polygon Flipped()
        {
            ...
            return new Polygon(Flags,newvertices, Shared, newplane);
        }
    }
