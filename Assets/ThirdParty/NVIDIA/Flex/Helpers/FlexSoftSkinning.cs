...
namespace NVIDIA.Flex
{
    ...
    public class FlexSoftSkinning : MonoBehaviour
    {
        ...
        #region Private
         ...
         public  void Create()
        {
            if(m_skinningTarget==null) m_skinningTarget = gameObject;// added by zwj
        ...
        void  CreateSkinningBones()
        {
            if (Application.isPlaying && m_actor && m_actor.asset && m_renderer && m_renderer.sharedMesh)
            {
                ...
                { 
                   ...
                   // bone.transform.localScale = Vector3.one * 0.1f;
        ...
        Mesh m_meshInstance;
        public Transform[] m_skinningBones = new Transform[0];
